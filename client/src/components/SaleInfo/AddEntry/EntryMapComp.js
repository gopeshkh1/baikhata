...
import { AddMultiEntry, AutoComplete } from "./CustomizedComp";
...
export default function EntryMapComp(props) {
  ...
  function requiredCheck(value) {
    ...
    //   setState((state) => ({ ...state, required_check }));
    // props.requiredFieldCheck(componentID);
  }
